...
public class frm_default extends JFrame implements ActionListener, MouseListener {
	...
	protected JButton jThongbao;
	protected theGioiThieu theGioiThieuPanel;
	protected JButton jbtThoat;
	...
	public frm_default() {
		...
		if (maTK_DaDangNhap != null) {
		    ...
		    jpTheGT.removeAll();
		    jpTheGT.add(gioiThieuBtn);
		    jpThanhCongCu.add(jpTheGT, BorderLayout.CENTER);
