...
public class BieuDoUtil {
    ...
    public static ChartPanel createPieChartPanel() {
        ...
        plot.setBackgroundPaint(new Color(180, 220, 85)); 
    ...
    public static ChartPanel createLineChartPanel() {
        DefaultCategoryDataset dataset = new DefaultCategoryDataset();
        dataset.addValue(2, "Lượt mua", "T1");
        dataset.addValue(4, "Lượt mua", "T2");
        dataset.addValue(5, "Lượt mua", "T3");
        dataset.addValue(6, "Lượt mua", "T4");
        dataset.addValue(3, "Lượt mua", "T5");
        dataset.addValue(8, "Lượt mua", "T6");
        dataset.addValue(9, "Lượt mua", "T7");
        dataset.addValue(4, "Lượt mua", "T8");
        dataset.addValue(1, "Lượt mua", "T9");
        dataset.addValue(4, "Lượt mua", "T10");
        dataset.addValue(7, "Lượt mua", "T11");
        dataset.addValue(10, "Lượt mua", "T12");
